...
namespace MarsRoverSimulator
{
	public class MarsRoverSimulator
	{
		public void Start()
		{
			...
			io.SendTextToUser(
				$"Rover 1 output {rover1.CurrentPosition.X} {rover1.CurrentPosition.Y} {rover1.CurrentPosition.Facing.ToString()}");
			...
			io.SendTextToUser(
				$"Rover 2 output {rover2.CurrentPosition.X} {rover2.CurrentPosition.Y} {rover2.CurrentPosition.Facing.ToString()}");
		}
	}
}